...
L1_C_values = np.linspace(0.01, 0.17, 35)  # Adjust the range and number of points as needed
L1_C_values = np.linspace(0.0273, 0.28, 120)  # Adjust the range and number of points as needed
...
plt.title('Model Performance vs Number of Features Used')
plt.legend()
plt.grid(True)
plt.show()
#%%
...
plt.show()
#%%
performance_metrics_df.to_csv('WALTZtht_featNum_performance.csv')